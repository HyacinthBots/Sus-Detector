...
We love to see when people contribute to the project! Our [Issues Page](https://github.com/HyacinthBots/Sus-Detector/issues)
...
1. ### Look at the code style
   Before you begin work on adding code to Sus-Detector, please spend some time looking through the rest of the code in
   Sus-Detector, and ensure in your Pull Request you follow the style as closely as you can.
...
2. ### Open your PR and wait for reviews
   Once you have forked Sus-Detector and opened a pull request, you will need to wait for reviews from other people. When you
